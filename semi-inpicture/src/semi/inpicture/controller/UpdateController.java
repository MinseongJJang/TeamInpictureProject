	...
	public String execute(HttpServletRequest request, HttpServletResponse response)
		...
		if (command.equals("ApplyArtist")) {
			...
			while (fileNames.hasMoreElements()) {
				...
				/*
				 * if(!fileOriName.endsWith(".doc") && !fileOriName.endsWith(".hwp") &&
				 * !fileOriName.endsWith(".png") && !fileOriName.endsWith(".jpg") &&
				 * !fileOriName.endsWith(".xls")) { String error = "파일을 업로드할 수 없습니다.";
				 * //request.setAttribute("error", error); File file = new File(workspacePath +
				 * fileName); file.delete(); } else { saveFiles.add(fileName); }
				 */
			}
			/*
