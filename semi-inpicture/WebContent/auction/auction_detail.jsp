...
<script>
   src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js">
	...
	<h2>작가 정보</h2>
			<div class="content">
				<form method="post" action="${pageContext.request.contextPath }/front" id="endAuction" enctype="multipart/form-data">
				<input type="hidden" name="command" value="EndAuction">
  				<input type="hidden" name="auctionNo" value="${requestScope.auctionDTO.auctionApplyDTO.auctionNo }">
					<table class="table" style="border-bottom:1px solid #dbdbdb" style="border-top:1px solid #dbdbdb" >
							...
							<tr>
								<td>작가 이름</td>
								<td colspan="2">${requestScope.auctionDTO.auctionApplyDTO.inpictureMemberDTO.name} </td>	
							</tr>
							<tr>
								<td colspan="3"></td>
							</tr>
							<tr>
								<td>경매 그림</td>
								<td colspan="2"><img src="${pageContext.request.contextPath }/auction_apply_images/${requestScope.auctionDTO.auctionApplyDTO.auctionMainPic}"></td>	
							</tr>		
							<tr>
								<td colspan="3"></td>
							</tr>
							...
							<tr>
								<td>최고 입찰가</td>
								<td colspan="2">${param.maxBid }</td>	
							</tr>							
						</table>
						<div align="center">
								<button type="button" class="newsletter_submit_btn" data-toggle="modal" data-target="#myModal" id="bidBtn">입찰</button>
						</div>
				</form>
		</div>
</div>
      ...
      <form action="${pageContext.request.contextPath }/front" method="post"
         ...
         <div class="modal-content">
            ...
            <div class="modal-footer">
               <button type="button" class="newsletter_submit_btn" data-dismiss="modal"
