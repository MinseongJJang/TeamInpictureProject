		...
		<div class="row myrow">
			<c:forEach items="${requestScope.lvo.mapList}" var="list"
				...
				<div class="column nature">
					<div class="content" onclick="location.href='${pageContext.request.contextPath }/front?command=AuctionArtDetail&auctionNo=${list.key.auctionApplyDTO.auctionNo}&maxBid=${list.value.auctionBidPrice }'">
							<img src="${pageContext.request.contextPath}/auction_apply_images/${list.key.auctionApplyDTO.auctionMainPic }">
						<h6 class="product_name">
							${list.key.auctionApplyDTO.auctionTitle }
						</h6>
			...
			<ul class="pagination">
				...
				<c:forEach var="page"
					...
					<c:choose>
						...
						<c:otherwise>
							<li><a href="front?command=ApplyAuctionArtList&nowPage=${page}">${page}</a></li>
						</c:otherwise>
					</c:choose>
